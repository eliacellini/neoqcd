...
#SBATCH --job-name=neoqcd-neorex-residual-production
...
NEOREX_FLOW_CHECKPOINT_NAME="${NEOREX_FLOW_CHECKPOINT_NAME:-residual_global.pt}"
TRAIN_STEPS=100
...
RUN_NAME="${RUN_NAME:-production_neorex_residual_obc_T${T}_L${L}_r8_d${DEFECT_SIZE}_bs${BS}_sw${SWEEP}_nsteps${NEOREX_PROTOCOL_STEPS}_hb${NEOREX_HEATBATH_STEPS_PER_STEP}_h${HYPER_HIDDEN_DIM}_depth${HYPER_DEPTH}}"
