...
#SBATCH --job-name=neoqcd-nemcmc-defect
...
BASE_RUN_NAME="${RUN_NAME:-production_nemcmc_defect_beta6_bc0to1_D${D}_T${T}_L${L}_N${N}_d${DEFECT_SIZE}_t${TIME_SLICE}_s${SPACE_SLICE}_bs${BS}_K${PROTOCOL_STEPS}}"
...
CFG_CACHE_TAG="${CFG_CACHE_TAG:-defect_D4_T8_L8_N3_beta6p0_bc0to1_d2_t4_s3_eval}"
