...
#SBATCH --job-name=neoqcd-snf-smearing-beta
...
BASE_RUN_NAME="${RUN_NAME:-production_snf_smearing_beta_D${D}_T${T}_L${L}_N${N}_bs${BS}_b6p02to6p178_K${PROTOCOL_STEPS}_h${HYPER_HIDDEN_DIM}_depth${HYPER_DEPTH}}"
